...
public class DataBase : MonoBehaviour
{
    ...
    public void SaveLevelData()
    {
        ...
        serializer.Serialize(stream, levelDB);
        stream.Close();
    }
    public void SaveScreenData()
    {
        ...
        serializer.Serialize(stream, screenDB);
        stream.Close();
    }
    public void SaveSoundData()
    {
        ...
        serializer.Serialize(stream, soundDB);
        stream.Close();
    }
    public void SaveSpriteData()
    {
        ...
        serializer.Serialize(stream, spriteDB);
        stream.Close();
    }
    ...
    public void SavePowerUPData()
    {
        ...
        serializer.Serialize(stream, powerupDB);
        stream.Close();
    }
    public void SaveObstacleData()
    {
        ...
        serializer.Serialize(stream, obstacleDB);
        stream.Close();
    }
    public void SaveProyectileData()
    {
        ...
        serializer.Serialize(stream, proyectileDB);
        stream.Close();
    }
    public void SaveAlienData()
    {
        ...
        serializer.Serialize(stream, alienDB);
        stream.Close();
    }
    ...
    public void LoadGameData()
    {
        ...
        gameDB = serializer.Deserialize(stream) as GameData;
        stream.Close();
    }
    public void LoadLevelData()
    {
        ...
        levelDB = serializer.Deserialize(stream) as LevelDatabase;
        stream.Close();
    }
    public void LoadScreenData()
    {
        ...
        screenDB = serializer.Deserialize(stream) as ScreenDatabase;
        stream.Close();
    }
    public void LoadSoundData()
    {
        ...
        soundDB = serializer.Deserialize(stream) as SoundDatabase;
        stream.Close();
    }
    public void LoadSpriteData()
    {
        ...
        spriteDB = serializer.Deserialize(stream) as SpriteDatabase;
        stream.Close();
    }
    public void LoadPlayerData()
    {
        ...
        playerDB = serializer.Deserialize(stream) as PlayerData;
        stream.Close();
    }
    public void LoadPowerUPData()
    {
        ...
        powerupDB = serializer.Deserialize(stream) as PowerUPDatabase;
        stream.Close();
    }
    public void LoadObstacleData()
    {
        ...
        obstacleDB = serializer.Deserialize(stream) as ObstacleDatabase;
        stream.Close();
    }
    public void LoadProyectileData()
    {
        ...
        proyectileDB = serializer.Deserialize(stream) as ProyectileDatabase;
        stream.Close();
    }
    public void LoadAlienData()
    {
        ...
        alienDB = serializer.Deserialize(stream) as AlienDatabase;
        stream.Close();
    }
}
